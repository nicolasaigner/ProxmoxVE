...
# upstream   https://github.com/nicolasaigner/ProxmoxVE.git (fetch)
# upstream   https://github.com/nicolasaigner/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/nicolasaigner/ProxmoxVE"
echo ""
