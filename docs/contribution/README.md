...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/nicolasaigner/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/nicolasaigner/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/nicolasaigner/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/nicolasaigner/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/nicolasaigner/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/nicolasaigner/ProxmoxVE/discussions)
